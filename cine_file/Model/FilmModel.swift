...
extension Array where Element == FilmModel {
    static func films() -> [FilmModel] { [
        FilmModel(imgName: "filme1", title: "Tudo em Todo o Lugar ao Mesmo Tempo", synopsis: "Uma imigrante chinesa de meia idade se envolve em uma aventura louca, onde só ela pode salvar o mundo explorando outros universos que se conectam com as vidas que ela poderia ter levado", direction: "Daniel Kwan, Daniel Scheinert", screenwriters: "Daniel Kwan, Daniel Scheinert", year: "2022", favorited: false, watched: false),
        FilmModel(imgName: "filme2", title: "Cisne negro", synopsis: "Uma esforçada bailarina luta para manter sua sanidade após obter o papel principal no Lago dos Cisnes de Tchaikovsky.", direction: "Darren Aronofsky", screenwriters: "Mark Heyman, Andres Heinz, John J. McLaughlin", year: "2010", favorited: false, watched: false),
        FilmModel(imgName: "filme3", title: "Barbie a princesa e a plebeia", synopsis: "Uma plebeia, moradora de um vilarejo, é muito parecida com a princesa do reino. Os destinos das duas se cruzam quando a princesa é sequestrada, e a moça humilde usa sua incrível semelhança com ela para tentar salvar das mãos do vilão.", direction: "William Lau", screenwriters: "Cliff Ruby, Elana Lesser, Ruth Handler", year: "2004", favorited: false, watched: false),
